...
export function obterDadosDoPortal() {
  return {
    ...
    cards: [
      {
        title: "Ivo",
        description: "Conheça o Ivo, desenvolvedor da InfoBio.",
        href: "/ivolzkm",
      ...
      },
      {
        ...
        description:
          "Explore conceitos de saúde e tecnologia de forma interativa.",
      ...
      },
      {
        title: "Blog",
        description:
          "Artigos, notícias e tutoriais sobre o universo da Informática Biomédica.",
        href: "/blog",
      ...
      },
      {
        title: "Comunidade",
        description:
          "Conecte-se com outros estudantes e profissionais da área.",
        href: "#",
        status: "soon",
      },
    ],
