  ...
  return (
    <main className="container mx-auto flex min-h-screen flex-col items-center p-8">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Card para UFCSPA */}
        <Link href="/comunidade/ufcspa" className="block p-6 bg-slate-800/50 rounded-lg border border-slate-700 hover:bg-slate-700 hover:border-sky-400 transition-all duration-300">
        ...
        {/* Card para USP */}
        <Link href="/comunidade/usp" className="block p-6 bg-slate-800/50 rounded-lg border border-slate-700 hover:bg-slate-700 hover:border-sky-400 transition-all duration-300">
        ...
        {/* Card para UFPR */}
        <Link href="/comunidade/ufpr" className="block p-6 bg-slate-800/50 rounded-lg border border-slate-700 hover:bg-slate-700 hover:border-sky-400 transition-all duration-300">
